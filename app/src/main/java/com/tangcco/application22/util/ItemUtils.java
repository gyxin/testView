package com.tangcco.application22.util;
...
public class ItemUtils {
    ...
    public static List<BaseItem> generateMockData() {
        ...
        list.add(new VideoItem(VIDEO_URL2, PIC_URL4));

        list.add(new VideoItem(VIDEO_URL2, PIC_URL3));

        list.add(new VideoItem(VIDEO_URL2, PIC_URL2));

        list.add(new VideoItem(VIDEO_URL2, PIC_URL1));
